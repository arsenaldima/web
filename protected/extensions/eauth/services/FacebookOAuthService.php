...
class FacebookOAuthService extends EOAuth2Service {
	 ...
	 */
	protected $scope = 'user_birthday,user_hometown,user_location,email';
	...
	protected function fetchAttributes() {
		...
		$this->attributes['birthdate'] = date('Y-m-d', strtotime($this->attributes['birthday']));
		$this->attributes['sex'] = $this->attributes['gender'] == 'male';
	}
